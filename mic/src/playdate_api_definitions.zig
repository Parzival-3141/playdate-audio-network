...
pub const PlaydateSys = extern struct {
    ...
    addOptionsMenuItem: *const fn (title: [*:0]const u8, optionTitles: [*][*:0]const u8, optionsCount: c_int, f: PDMenuItemCallbackFunction, userdata: ?*anyopaque) callconv(.C) *PDMenuItem,
